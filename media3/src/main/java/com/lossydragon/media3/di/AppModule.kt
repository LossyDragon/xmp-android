...
import com.lossydragon.media3.player.XmpRenderEngine
import com.lossydragon.media3.player.XmpSimplePlayer
...
val appModule = module {
    ...
    single { XmpRenderEngine(androidContext()) }
    single { XmpSimplePlayer(androidContext(), get()) }
    single {
