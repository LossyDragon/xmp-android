...
//		}
    ...
    public void onCreate(final Bundle icicle) {
        ...
        viewerLayout.addView(viewer);
        viewerLayout.setOnClickListener(view -> {
            synchronized (playerLock) {
                if (canChangeViewer) {
                    changeViewer();
                }
        ...
        elapsedTime.setOnClickListener(view -> showElapsed ^= true);
    ...
    public boolean onOptionsItemSelected(final MenuItem item) {
        if (item.getItemId() == R.id.menu_delete) {
            Message.yesNoDialog(activity, "Delete", "Are you sure to delete this file?", () -> {
                try {
