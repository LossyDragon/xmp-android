...
public class FilelistActivity extends BasePlaylistActivity implements PlaylistAdapter.OnItemClickListener {
     ...
     */
    private final PlaylistChoice addRecursiveToPlaylistChoice = (fileSelection, playlistSelection) ->
     ...
     */
    private final PlaylistChoice addFileToPlaylistChoice = (fileSelection, playlistSelection) ->
     ...
     */
    private final PlaylistChoice addFileListToPlaylistChoice = (fileSelection, playlistSelection) ->
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        mPlaylistAdapter = new PlaylistAdapter(this, new ArrayList<>(), false, PlaylistAdapter.LAYOUT_LIST);
    ...
    public boolean onContextItemSelected(final MenuItem item) {
        ...
        if (mPlaylistAdapter.getFile(position).isDirectory()) {        // Directories
            ...
            switch (id) {
                ...
                case 4:                                        //   Delete file
                    final String deleteName = mPlaylistAdapter.getFilename(position);
                    Message.yesNoDialog(this, "Delete", "Are you sure you want to delete " + FileUtils.basename(deleteName) + "?", () -> {
