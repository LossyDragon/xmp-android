...
public class Sidebar {
    ...
    public Sidebar(final PlayerActivity activity) {
        ...
        allSequencesButton.setOnClickListener(v -> allSequencesButton.setImageResource(activity.toggleAllSequences() ? R.drawable.sub_on : R.drawable.sub_off));
        ...
        seqGroupListener = (group, checkedId) -> {
    ...
    public void addSequence(final int num, final int duration) {
        ...
        final String text = num == 0 ? "main song" : "subsong " + num;
