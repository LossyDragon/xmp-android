...
Java_org_helllabs_xmp_Xmp_init(JNIEnv *env, jobject obj, jint rate, jint ms) {
...
Java_org_helllabs_xmp_Xmp_deinit(JNIEnv *env, jobject obj) {
    xmp_free_context(ctx);
    OpenSL::close_audio();
}

JNIEXPORT jint JNICALL
Java_org_helllabs_xmp_Xmp_loadModule(JNIEnv *env, jobject obj, jstring name) {
    const char *filename;
    int res;
...
JNIEXPORT jboolean JNICALL
Java_org_helllabs_xmp_Xmp_testModule(JNIEnv *env, jobject obj, jstring name, jobject info) {
    const char *filename;
    int i, res;
    ...
    if (res == 0) {
        if (info != nullptr) {
            jclass modInfoClass = (*env).FindClass("org/helllabs/xmp/ModInfo");
            jfieldID field;
...
JNIEXPORT jint JNICALL
Java_org_helllabs_xmp_Xmp_releaseModule(JNIEnv *env, jobject obj) {
    int res = 0;
...
JNIEXPORT jint JNICALL
Java_org_helllabs_xmp_Xmp_startPlayer(JNIEnv *env, jobject obj, jint rate) {
    int i, ret;
...
JNIEXPORT jint JNICALL
Java_org_helllabs_xmp_Xmp_endPlayer(JNIEnv *env, jobject obj) {
    int res = 0;
...
JNIEXPORT jint JNICALL
Java_org_helllabs_xmp_Xmp_playAudio(JNIEnv *env, jobject obj) {
    return OpenSL::play_audio();
}

JNIEXPORT void JNICALL
Java_org_helllabs_xmp_Xmp_dropAudio(JNIEnv *env, jobject obj) {
    return OpenSL::drop_audio();
}

JNIEXPORT jboolean JNICALL
Java_org_helllabs_xmp_Xmp_stopAudio(JNIEnv *env, jobject obj) {
    return OpenSL::stop_audio() == 0 ? JNI_TRUE : JNI_FALSE;
}

JNIEXPORT jboolean JNICALL
Java_org_helllabs_xmp_Xmp_restartAudio(JNIEnv *env, jobject obj) {
    return OpenSL::restart_audio() == 0 ? JNI_TRUE : JNI_FALSE;
}

JNIEXPORT jboolean JNICALL
Java_org_helllabs_xmp_Xmp_hasFreeBuffer(JNIEnv *env, jobject obj) {
    return OpenSL::has_free_buffer() ? JNI_TRUE : JNI_FALSE;
}

JNIEXPORT jint JNICALL
Java_org_helllabs_xmp_Xmp_fillBuffer(JNIEnv *env, jobject obj, jboolean looped) {
    return OpenSL::fill_buffer(looped);
}

JNIEXPORT jint JNICALL
Java_org_helllabs_xmp_Xmp_nextPosition(JNIEnv *env, jobject obj) {
    return xmp_next_position(ctx);
}

JNIEXPORT jint JNICALL
Java_org_helllabs_xmp_Xmp_prevPosition(JNIEnv *env, jobject obj) {
    return xmp_prev_position(ctx);
}

JNIEXPORT jint JNICALL
Java_org_helllabs_xmp_Xmp_setPosition(JNIEnv *env, jobject obj, jint n) {
    return xmp_set_position(ctx, n);
}

JNIEXPORT jint JNICALL
Java_org_helllabs_xmp_Xmp_stopModule(JNIEnv *env, jobject obj) {
    xmp_stop_module(ctx);
    return 0;
}

JNIEXPORT jint JNICALL
Java_org_helllabs_xmp_Xmp_restartModule(JNIEnv *env, jobject obj) {
    xmp_restart_module(ctx);
    return 0;
}

JNIEXPORT jint JNICALL
Java_org_helllabs_xmp_Xmp_seek(JNIEnv *env, jobject obj, jint time) {
    int ret;
    int i;
...
JNIEXPORT jint JNICALL
Java_org_helllabs_xmp_Xmp_time(JNIEnv *env, jobject obj) {
    return _playing ? fi[_before].time : -1;
}

JNIEXPORT jint JNICALL
Java_org_helllabs_xmp_Xmp_mute(JNIEnv *env, jobject obj, jint chn, jint status) {
    return xmp_channel_mute(ctx, chn, status);
}

JNIEXPORT void JNICALL
Java_org_helllabs_xmp_Xmp_getInfo(JNIEnv *env, jobject obj, jintArray values) {
    int v[7];
...
JNIEXPORT void JNICALL
Java_org_helllabs_xmp_Xmp_setPlayer(JNIEnv *env, jobject obj, jint parm, jint val) {
    xmp_set_player(ctx, parm, val);
}

JNIEXPORT jint JNICALL
Java_org_helllabs_xmp_Xmp_getPlayer(JNIEnv *env, jobject obj, jint parm) {
    return xmp_get_player(ctx, parm);
}

JNIEXPORT jint JNICALL
Java_org_helllabs_xmp_Xmp_getLoopCount(JNIEnv *env, jobject obj) {
    return fi[_before].loop_count;
}

JNIEXPORT void JNICALL
Java_org_helllabs_xmp_Xmp_getModVars(JNIEnv *env, jobject obj, jintArray vars) {
...
Java_org_helllabs_xmp_Xmp_getVersion(JNIEnv *env, jobject obj) {
    return (*env).NewStringUTF(xmp_version);
}

JNIEXPORT jobjectArray JNICALL
Java_org_helllabs_xmp_Xmp_getFormats(JNIEnv *env, jobject obj) {
    jstring s;
    jclass stringClass;
...
JNIEXPORT jstring JNICALL
Java_org_helllabs_xmp_Xmp_getModName(JNIEnv *env, jobject obj) {
    const char *s = _mod_is_loaded ? mi.mod->name : "";
    return (*env).NewStringUTF(s);
}

JNIEXPORT jstring JNICALL
Java_org_helllabs_xmp_Xmp_getModType(JNIEnv *env, jobject obj) {
    const char *s = _mod_is_loaded ? mi.mod->type : "";
    return (*env).NewStringUTF(s);
}

JNIEXPORT jstring JNICALL
Java_org_helllabs_xmp_Xmp_getComment(JNIEnv *env, jobject obj) {
    if (mi.comment)
...
JNIEXPORT jobjectArray JNICALL
Java_org_helllabs_xmp_Xmp_getInstruments(JNIEnv *env, jobject obj) {
    jstring s;
    jclass stringClass;
    jobjectArray stringArray;
    int i;
...
JNIEXPORT void JNICALL
Java_org_helllabs_xmp_Xmp_getChannelData(JNIEnv *env, jobject obj, jintArray vol,
                                                 jintArray finalvol,
...
JNIEXPORT void JNICALL
Java_org_helllabs_xmp_Xmp_getPatternRow(JNIEnv *env, jobject obj, jint pat, jint row,
...
JNIEXPORT void JNICALL
Java_org_helllabs_xmp_Xmp_getSampleData(JNIEnv *env, jobject obj, jboolean trigger,
                                                jint ins, jint key,
...
JNIEXPORT jboolean JNICALL
Java_org_helllabs_xmp_Xmp_setSequence(JNIEnv *env, jobject obj, jint seq) {
...
JNIEXPORT void JNICALL
Java_org_helllabs_xmp_Xmp_getSeqVars(JNIEnv *env, jobject obj, jintArray vars) {
    int i, num, v[16];
...
JNIEXPORT jint JNICALL
Java_org_helllabs_xmp_Xmp_getVolume(JNIEnv *env, jobject obj) {
    return OpenSL::get_volume();
}

JNIEXPORT jint JNICALL
Java_org_helllabs_xmp_Xmp_setVolume(JNIEnv *env, jobject obj, jint vol) {
    return OpenSL::set_volume(vol);
}

JNIEXPORT jint JNICALL
Java_org_helllabs_xmp_Xmp_getMaxSequences(JNIEnv *env, jobject obj) {
